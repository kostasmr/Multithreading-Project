...
//    char basedir[MAX_FILENAME];
    ...
    SST* sst;
    MemTable* memtable;
    pthread_mutex_t general_lock;       //lock for writers and readers
    pthread_mutex_t readers_lock;       //lock for readers
    int readers;                        //helper variable for how many readers are in 
} DB;
